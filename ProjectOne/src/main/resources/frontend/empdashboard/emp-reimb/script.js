...
async function getReimbursement() {
    ...
    let response = await fetch(`${domain}/login/empdashboard/test/${reimbId}`);
...
function createTable(data) {
    ...
    switch (data.reimbStatus) {
        case 1:
            ...
            break;
        case 2:
            currentStatus.placeholder = "Pending";
            break;
        case 3:
